...
export default function Home({users}) {
    ...
    {/* <!-----------I want to put here the capability to add a way to estimate your take home pay--> */}
					...
					<form>
						<label type="text"className="container" nameday="Name of the day week">Monday</label>
						<input type="text"name="submit" value={newMonday}onChange={(e) =>setNewMonday(e.target.value)}/>
						{/* <input type="text"className="userContainer input-blank"  onChange={(e) => (setNewMonday(e.target.value))}></input> */}

						<label type="text" className="container" nameday="Name of the day week">Tuesday</label>
						<input type="text"name="submit" value={newTuesday}onChange={(e) =>setNewTuesday(e.target.value)}/>
						{/* <input type="text" className="container" onChange={(e) => (setNewTuesday(e.target.value))}></input> */}

						<label type="text" className="container" nameday="Name of the day week">Wednesday</label>
						<input type="text"name="submit" value={newWednesday}onChange={(e) =>setNewWednesday(e.target.value)}/>
						{/* <input type="text" className="container" onChange={(e) => (setNewWednesday(e.target.value))}></input> */}

						<label type="text" className="container" nameday="Name of the day week">Thursday</label>
						...
						<label type="text" className=" container" nameday="Name of the day week">Friday</label>
						...
						<label type="text" className="container"  nameday="Name of the day week">Saturday</label>
						<input type="text"name="submit"value={newSaturday}onChange={(e) =>setNewSaturday(e.target.value)}/>
						{/* <input type="text" className="container" onChange={(e) => (setNewSaturday(e.target.value))}></input> */}

						<label type="text" className="container " nameday="Name of the day week">Sunday</label>
						<input type="text"name="submit"value={newSunday}onChange={(e) =>setNewSunday(e.target.value)}/>
						{/* <input type="text" className="container" onChange={(e) => (setNewSunday(e.target.value))}></input> */}

						<label type="text" className="container " nameday="Name of the day week">Extra</label>
						<input type="text"name="submit"value={newExtra}onChange={(e) =>setNewExtra(e.target.value)}/>
						{/* <input type="text" className=" container" onChange={(e) => (setNewExtra(e.target.value))}></input>	 */}
					...
					<div className="container-table header"></div>
						...
						<label type="text" className="boxed-header container-table">Enter your Pay</label>
	            ...
	            {/* <input type="text" className= "boxed-header"onChange={(e) => setNewFed(e.target.value)}></input>  */}
				...
				{/* <input type="text"onChange={(e) => setNewFicaMed(e.target.value)}></input> */}
 				...
 				{/* <input type="text"onChange={(e) => setNewFicaSs(e.target.value)}></input> */}
				...
				{/* <input type"text"onChange={(e)=>setNewQuarterwcomp }></input> */}
			...
			<form>
				...
				{/* <input type="text"className="boxed-header" onChange={(e) => setNewState(e.target.value)}></input> */}
			...
			<p>This is the amount to save for a Roth, Emergency, some other plans money.</p>
			<p>I recomend at least 10% for Roth monthly if not more, or 10% for savings, instead save for something else</p>

			<label type="text"className="boxed-header">Roth</label>
			<input type="text"name="submit"value={newUpdate}onChange={(e) =>setNewUpdate(e.target.value)}/>
			
			<label type="text"className="boxed-header">Emergency Save</label>
			<input type="text"name="submit"value={newUpdate}onChange={(e) =>setNewUpdate(e.target.value)}/>

			<label type="text"className="boxed-header">Other Saving</label>
			<input type="text"name="submit"value={newUpdate}onChange={(e) =>setNewUpdate(e.target.value)}/>

			<h3 className='text-center'>Spendable Money</h3>
			<p>This is the amount of money to be able to take over to finances page</p>
			</>
			</div>
